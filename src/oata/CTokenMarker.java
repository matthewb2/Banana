...
public class CTokenMarker extends DefaultStyledDocument  {
	private static final long serialVersionUID = 1L;
    private Style _defaultStyle;
    private Style _cwStyle;
    private Style _commentStyle;
    
	public CTokenMarker(Style defaultStyle)  {
	...
	public void insertString (int offset, String str, AttributeSet a) throws BadLocationException {
     ...
     private static final boolean isReservedWord(String word) {
         return(word.toUpperCase().trim().equals("char") || 
                        ...
                        word.toUpperCase().trim().equals("asmlinkage") ||
                        word.toUpperCase().trim().equals("far") ||
                        word.toUpperCase().trim().equals("huge") ||
                        word.toUpperCase().trim().equals("inline") ||
                        word.toUpperCase().trim().equals("near") ||
                        word.toUpperCase().trim().equals("pascal") ||
